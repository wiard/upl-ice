...
ATOMGATE_POLICY = {
    ...
    "checked": "mock_basket_payment_release_allowed",
    "failed": "mock_basket_payment_denied",
    "contradicted": "mock_basket_payment_denied_contradicted",
    "inconclusive": "mock_basket_payment_hold",
    "out_of_scope": "mock_basket_payment_denied_out_of_scope",
}
